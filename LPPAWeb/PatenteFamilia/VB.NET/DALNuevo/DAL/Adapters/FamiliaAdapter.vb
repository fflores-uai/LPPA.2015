...
Namespace DAL.Adapters
    Public Class FamiliaAdapter
        ...
        Public Sub Fill(ByVal _object As Familia)
            _object.set_IdFamiliaElement(CStr(Me.row.Item("IdFamilia")))
            _object.set_Nombre(CStr(Me.row.Item("Nombre")))
            Dim relacionesFamilia As DataTable = Familia.GetAccesos(_object.get_IdFamiliaElement)
            ...
            Next
            Dim relacionesPatentes As DataTable = Familia_Patente.GetAccesos(_object.get_IdFamiliaElement)
            Dim rowAccesos As DataRow
